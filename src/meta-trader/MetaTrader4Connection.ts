...
export class MetaTrader4Connection extends Listener {
  ...
  public connect() {
    ...
    this.reqSocket.monitor(1000, 1).connect(reqUrl);
    this.pullSocket.monitor(1000, 1).connect(pullUrl);
    ...
    this.pullSocket.on('message', (msg: any) => {
      ...
      if (message.type === 'RESPONSE') {
        ...
        // console.log('message stram', message.id, message.json);
  ...
  private _reqConnected = false;
  private _pullConnected = false;
